...
class UserViewSet(viewsets.GenericViewSet):
    ...
    def login(self, request):
        ...
        serializer.is_valid(raise_exception=True) #Manda a validar la info del usuario
        user, token = serializer.save() #Envía la info validada al método create del serializer
        data = {
